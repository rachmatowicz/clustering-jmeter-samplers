...
public class NativeClusteringEJBRequestSampler extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
            ...
            LOG.trace("{}: Serial {}: After successful increment: StartTime: {} TimeStamp: {} EndTime: {} ElapsedTime: {}", threadName, serial, sampleResult.getStartTime(), sampleResult.getTimeStamp()
                    , sampleResult.getEndTime(), sampleResult.getTime());
        } catch (Exception e) {
     ...
     * invalid.
     *
     * @param sampleResult sampleResult instance for storing the validation results
     * @param gotSerial    counter for this bean call
     */
